...
namespace CassInformationSystem.EnitiyFramework.DBContext;

public partial class CassDbContext : DbContext
{
    public CassDbContext()
    {
    }

    public CassDbContext(DbContextOptions<CassDbContext> options)
        : base(options)
    {
    }
    ...
    {
        modelBuilder.Entity<ShipperShipmentDetails>().HasNoKey();
